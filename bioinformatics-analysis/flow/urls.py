...
group_router.register(r"^/panelGroups",
                      views.PanelGroupView,
                      basename="panelGroups")

panel_router = routers.DefaultRouter()
panel_router.register(r"^/panels", views.PanelView, basename="panels")

other_urls = [
    url(r"^/upload-excel", views.upload_excel, name="upload_excel"),
    url(r"^/flows/query", views.FlowView.as_view({"post": "query"})),
    url(r"^/flows/list_fields", views.FlowView.as_view({"get": "list_types"})),
    url(
        r"^/members",
        views.FlowView.as_view({
            "post": "add_members",
