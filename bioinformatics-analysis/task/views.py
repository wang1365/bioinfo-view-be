...
class TaskView(ModelViewSet):
    ...
    def _build_row(self, task, sample, task_sample: TaskSample):
        ...
        row.append(sample_meta.sampling_tube_brand if sample_meta else "")
        row.append(sample_meta.specimen_type if sample_meta else "")
        ...
        row.append(patient.gestation if patient else "")
        row.append(patient.pregnancy_status if patient else "")
        ...
        row.append(sample.tag_label if sample else "")
