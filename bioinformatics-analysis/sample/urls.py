...
router.register(r'^/sampledatas',
                views.SampleMetaView,
                basename="samples_datas")

other_urls = [
    url(r"^/download/(?P<pk>\d+)$", views.download),
    url(
        r"^/samples/template/download",
        lambda req: views.download_by_choices(
            req, [SAMPLE_TEMPLATE_PATH, SAMPLE_TEMPLATE_EN_PATH]),
    ),
    url(
    ...
    url(
        r"^/samplemeta/export",
        views.SampleMetaView.as_view({"get": "export"}),
    ),
    ...
    url(
        ...
        lambda req: views.download_by_choices(
            req, [SAMPLE_META_TEMPLATE_PATH, SAMPLE_META_TEMPLATE_EN_PATH]),
    ),
