...
alter sequence action_id_seq owner to postgres;

create sequence appearance_sitelayout_id_seq;

alter sequence appearance_sitelayout_id_seq owner to postgres;
...
alter sequence django_site_id_seq owner to postgres;

create sequence flow_id_seq
	maxvalue 2147483647;

alter sequence flow_id_seq owner to postgres;

create sequence flow_members_id_seq
	maxvalue 2147483647;

alter sequence flow_members_id_seq owner to postgres;

create sequence flow_samples_id_seq
	maxvalue 2147483647;

alter sequence flow_samples_id_seq owner to postgres;

create sequence panel_group_id_seq
	maxvalue 2147483647;

alter sequence panel_group_id_seq owner to postgres;

create sequence panel_id_seq
	maxvalue 2147483647;

alter sequence panel_id_seq owner to postgres;

create sequence patient_patient_id_seq
	maxvalue 2147483647;

alter sequence patient_patient_id_seq owner to postgres;

create sequence permission2action_id_seq
	maxvalue 2147483647;

alter sequence permission2action_id_seq owner to postgres;
...
alter sequence project_members_id_seq owner to postgres;

create sequence project_samples_id_seq
	maxvalue 2147483647;

alter sequence project_samples_id_seq owner to postgres;
...
alter sequence resource_id_seq owner to postgres;

create sequence resource_limit_resourcelimit_id_seq;

alter sequence resource_limit_resourcelimit_id_seq owner to postgres;
...
create sequence role_permission2action_id_seq
	maxvalue 2147483647;

alter sequence role_permission2action_id_seq owner to postgres;

create sequence sample_meta_id_seq
	maxvalue 2147483647;

alter sequence sample_meta_id_seq owner to postgres;

create sequence samples_id_seq
	maxvalue 2147483647;

alter sequence samples_id_seq owner to postgres;
...
create sequence task_sample_id_seq
	maxvalue 2147483647;

alter sequence task_sample_id_seq owner to postgres;

create sequence user2role_id_seq
	maxvalue 2147483647;

alter sequence user2role_id_seq owner to postgres;

create sequence account_id_seq1;

alter sequence account_id_seq1 owner to postgres;

create sequence action_id_seq1;

alter sequence action_id_seq1 owner to postgres;

create sequence appearance_sitelayout_id_seq1;

alter sequence appearance_sitelayout_id_seq1 owner to postgres;
...
create sequence config_id_seq1;

alter sequence config_id_seq1 owner to postgres;
...
create sequence django_site_id_seq1;

alter sequence django_site_id_seq1 owner to postgres;

create sequence flow_id_seq1;

alter sequence flow_id_seq1 owner to postgres;

create sequence flow_members_id_seq1;

alter sequence flow_members_id_seq1 owner to postgres;

create sequence flow_samples_id_seq1;

alter sequence flow_samples_id_seq1 owner to postgres;

create sequence panel_id_seq1;

alter sequence panel_id_seq1 owner to postgres;

create sequence panel_group_id_seq1;

alter sequence panel_group_id_seq1 owner to postgres;

create sequence patient_patient_id_seq1
	maxvalue 2147483647;

alter sequence patient_patient_id_seq1 owner to postgres;

create sequence permission_id_seq1;

alter sequence permission_id_seq1 owner to postgres;

create sequence permission2action_id_seq1;

alter sequence permission2action_id_seq1 owner to postgres;

create sequence project_id_seq1;

alter sequence project_id_seq1 owner to postgres;

create sequence project_members_id_seq1;

alter sequence project_members_id_seq1 owner to postgres;

create sequence project_samples_id_seq1;

alter sequence project_samples_id_seq1 owner to postgres;

create sequence report_report_id_seq1;

alter sequence report_report_id_seq1 owner to postgres;

create sequence resource_id_seq1;

alter sequence resource_id_seq1 owner to postgres;

create sequence resource_limit_resourcelimit_id_seq1;

alter sequence resource_limit_resourcelimit_id_seq1 owner to postgres;

create sequence role_id_seq1;

alter sequence role_id_seq1 owner to postgres;

create sequence role_permission2action_id_seq1;

alter sequence role_permission2action_id_seq1 owner to postgres;

create sequence sample_meta_id_seq1;

alter sequence sample_meta_id_seq1 owner to postgres;

create sequence samples_id_seq1;

alter sequence samples_id_seq1 owner to postgres;

create sequence task_id_seq1;

alter sequence task_id_seq1 owner to postgres;

create sequence user2role_id_seq1;

alter sequence user2role_id_seq1 owner to postgres;
...
alter sequence account_id_seq1 owned by account.id;
...
alter sequence action_id_seq1 owned by action.id;
...
alter sequence appearance_sitelayout_id_seq owned by appearance_sitelayout.id;

alter sequence appearance_sitelayout_id_seq1 owned by appearance_sitelayout.id;
...
alter sequence auth_user_groups_id_seq1 owned by auth_user_groups.id;
...
alter sequence config_id_seq1 owned by config.id;
...
alter sequence django_content_type_id_seq1 owned by django_content_type.id;
...
alter sequence auth_group_permissions_id_seq1 owned by auth_group_permissions.id;
...
alter sequence auth_user_user_permissions_id_seq1 owned by auth_user_user_permissions.id;
...
alter sequence django_admin_log_id_seq1 owned by django_admin_log.id;
...
alter sequence django_site_id_seq1 owned by django_site.id;
...
alter sequence flow_id_seq owned by flow.id;

alter sequence flow_id_seq1 owned by flow.id;
...
alter sequence flow_members_id_seq owned by flow_members.id;

alter sequence flow_members_id_seq1 owned by flow_members.id;
...
alter sequence flow_samples_id_seq owned by flow_samples.id;

alter sequence flow_samples_id_seq1 owned by flow_samples.id;
...
alter sequence panel_id_seq1 owned by panel.id;
...
alter sequence panel_group_id_seq owned by panel_group.id;

alter sequence panel_group_id_seq1 owned by panel_group.id;
...
alter sequence patient_patient_id_seq1 owned by patient_patient.id;
...
alter sequence permission_id_seq1 owned by permission.id;
...
alter sequence permission2action_id_seq owned by permission2action.id;

alter sequence permission2action_id_seq1 owned by permission2action.id;
...
alter sequence project_id_seq1 owned by project.id;
...
alter sequence project_members_id_seq1 owned by project_members.id;
...
alter sequence report_report_id_seq owned by report_report.id;

alter sequence report_report_id_seq1 owned by report_report.id;
...
alter sequence resource_id_seq1 owned by resource.id;
...
alter sequence resource_limit_resourcelimit_id_seq owned by resource_limit_resourcelimit.id;

alter sequence resource_limit_resourcelimit_id_seq1 owned by resource_limit_resourcelimit.id;
...
alter sequence role_permission2action_id_seq owned by role_permission2action.id;

alter sequence role_permission2action_id_seq1 owned by role_permission2action.id;
...
(
	...
	patient_id bigint,
	user_id integer
		constraint sample_meta_user_id_468431b6_fk_account_id
			references account
				deferrable initially deferred
);
...
alter sequence sample_meta_id_seq owned by sample_meta.id;

alter sequence sample_meta_id_seq1 owned by sample_meta.id;
...
create index sample_meta_user_id_468431b6
	on sample_meta (user_id);
...
(
	...
	fastq2_path varchar(1024),
	create_time timestamp(6) with time zone,
	modify_time timestamp(6) with time zone,
	sample_meta_id integer,
	user_id integer
		constraint samples_user_id_9638cfba_fk_account_id
			references account
				deferrable initially deferred,
	fastq1_path_list varchar(1024) default ''::character varying,
	fastq2_path_list varchar(1024) default ''::character varying,
	fastq_merge_required boolean default false not null
);
...
alter sequence samples_id_seq1 owned by samples.id;
...
alter sequence project_samples_id_seq1 owned by project_samples.id;
...
create index samples_user_id_9638cfba
	on samples (user_id);
	...
	project_id integer not null
		constraint task_project_id_963d6354_fk_project_id
			references project
				deferrable initially deferred,
	log text,
	deleted_tempdir boolean not null,
	"error_message_CN" text,
	"error_message_EN" text,
	"result_path_CN" text,
	"result_path_EN" text,
	samples_first jsonb not null,
	samples_second jsonb not null
);
...
alter sequence task_id_seq1 owned by task.id;
...
(
	id integer default nextval('task_sample_id_seq'::regclass) not null
		constraint task_sample_pkey
			primary key,
	create_time timestamp(6) with time zone not null,
	update_time timestamp(6) with time zone not null,
	sample_id integer not null
		constraint task_sample_sample_id_663a6751_fk_samples_id
			references samples
				deferrable initially deferred,
	task_id integer not null
		constraint task_sample_task_id_d5b6aae2_fk_task_id
			references task
				deferrable initially deferred,
	create_time_timestamp integer generated always as (EXTRACT(epoch FROM (create_time AT TIME ZONE 'UTC'::text))) stored,
	update_time_timestamp integer generated always as (EXTRACT(epoch FROM (create_time AT TIME ZONE 'UTC'::text))) stored
);

alter table task_sample owner to postgres;

alter sequence task_sample_id_seq owned by task_sample.id;

create index task_sample_sample_id_663a6751
	on task_sample (sample_id);

create index task_sample_task_id_d5b6aae2
	on task_sample (task_id);
...
alter sequence user2role_id_seq1 owned by user2role.id;
